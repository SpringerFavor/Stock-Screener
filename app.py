...
from network_data import (
    NETWORK_COMPANIES, NETWORK_EDGES, EDGE_LOOKUP, SECTOR_COLORS, REL_COLORS,
)
...
# Legacy aliases — the rest of the file uses underscore-prefixed names
_NETWORK_COMPANIES = NETWORK_COMPANIES
_NETWORK_EDGES     = NETWORK_EDGES
_EDGE_LOOKUP       = EDGE_LOOKUP
_SECTOR_COLORS     = SECTOR_COLORS
_REL_COLORS        = REL_COLORS
